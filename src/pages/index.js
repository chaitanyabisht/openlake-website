      ...
      <Paper className={classes.centerText} elevation={0}>
        <Container maxWidth="lg" style={{ padding: '3rem' }}>
          ...
          <Typography paragraph>
            ...
            learning libraries that heavily govern the advancements in
            Artificial Intelligence today, both of these are driven and
            developed by open source communities in collaboration with corporate
            firms.
          </Typography>

          <Typography paragraph>
            With the importance of Open Source made crystal clear. There is one
            problem that needs to be addressed: Connecting people with Open
            Source Communities. The idea of OpenLake is to act as a bridge
            between Students and the World of Open Source Development.
          </Typography>
